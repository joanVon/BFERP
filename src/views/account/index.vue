<template>
  <div class="page-content page-left-nav account">
    ...
    <div class="table-container">
      ...
      <el-table :data="accountTable" stripe style="width: 100%" max-height="450">
      ...
      <el-table-column prop="active" label="状态">
        <template slot-scope="scope">
          <span v-if="scope.active === 0">--</span>
          <span v-else>在职</span>
        </template>
      </el-table-column>
      <el-table-column fixed="right" label="操作">
        <template slot-scope="scope">
          <el-button @click.native.prevent="modifyRow(scope.$index, accountTable)" type="primary" size="mini">
            修改
          </el-button>
          <el-button @click.native.prevent="deleteRow(scope.$index, accountTable)" size="mini">
            删除
          </el-button>
        </template>
      </el-table-column>
